...
console.log(dateNow); // Mon Apr 27 2026 14:33:35 GMT+0300 (Eastern European Summer Time)
console.log(dateNow.getTime()); // 1777289367033
...
console.log(dateNow.getMinutes()); // 33
console.log(dateNow.getSeconds()); // 35
