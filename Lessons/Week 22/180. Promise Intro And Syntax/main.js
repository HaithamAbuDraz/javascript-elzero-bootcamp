...
let resolver = (resolveValue) => console.log(`Good ${resolveValue}`); // Good Connection Established
let rejecter = (rejectValue) => console.log(`Bad ${rejectValue}`); // Bad Error: Connection Failed
