...
Identical in every way except that one of them doesn't contain game versions.
Only use Loop For to iterate through the elements.
All you have to do is solve the instructions and fill in the blanks to achieve the desired result.
The code structure must not be altered; simply replace the question marks with your own code.
*/
